...
Alternatively, you can always have a look at the [implementation](https://github.com/quizlet/material-ui/blob/master/packages/material-ui/src/Button/Button.js).
