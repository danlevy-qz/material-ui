...
- **做出一些改变吧**。 
  ...
  - 通过 [创建一个问题](https://github.com/quizlet/material-ui/issues/new) 来报告错误或缺少的功能 。
  - 查看和评论一些现有的 [pull requests](https://github.com/quizlet/material-ui/pulls) 和 [issues](https://github.com/quizlet/material-ui/issues)。
  - 帮助我们 [翻译](https://translate.material-ui.com) 文档。
  - 通过 [提交的一个 pull request](https://github.com/quizlet/material-ui/pulls) 来 [优化我们的文档](https://github.com/quizlet/material-ui/tree/master/docs)，修复错误，或者添加功能。
