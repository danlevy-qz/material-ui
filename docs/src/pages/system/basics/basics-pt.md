...
- 🚀 [Rápido o suficiente](https://github.com/quizlet/material-ui/blob/master/packages/material-ui-benchmark/README.md#material-uisystem) para não ser um gargalo em tempo de execução.
