...
Schauen Sie sich das [Create React App mit TypeScript](https://github.com/quizlet/material-ui/tree/master/examples/create-react-app-with-typescript) Beispiel an.
