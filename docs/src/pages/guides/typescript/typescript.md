...
Have a look at the [Create React App with TypeScript](https://github.com/quizlet/material-ui/tree/master/examples/create-react-app-with-typescript) example.
