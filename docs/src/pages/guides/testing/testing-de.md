...
To learn more about the internal tests, you can have a look at the [README](https://github.com/quizlet/material-ui/blob/master/test/README.md). Material-UI has **a wide range** of tests so we can iterate with confidence on the components, for instance, the visual regression tests provided by [Argos-CI](https://www.argos-ci.com/mui-org/material-ui) have proven to be really helpful.
