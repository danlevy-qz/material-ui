...
> 此文档尚未完成。 您是否已经升级了站点并且遇到了一些并没有在此涉及的问题？ [请在 GitHub 添加您的更改](https://github.com/quizlet/material-ui/blob/master/docs/src/pages/guides/migration-v3/migration-v3.md)。
...
—我们已经不再使用`theme.spacing.unit`，请参照新的 API：
  ...
  您可以在项目中使用 [迁移小帮手](https://github.com/quizlet/material-ui/tree/master/packages/material-ui-codemod/README.md#theme-spacing-api)来让您的迁移流程更加顺畅。
...
- [Typography] 按照 [该讨论](https://github.com/quizlet/material-ui/issues/13028) 的逻辑，我们将 `color="default"` 重命名为 `color="initial"`。 您不应该再使用 *default*，它缺少明确的语义。
