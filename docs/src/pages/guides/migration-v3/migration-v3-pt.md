...
> Este documento está em constante evolução. Você atualizou seu site e encontrou algo que não é abordado aqui? [Adicione suas alterações no GitHub](https://github.com/quizlet/material-ui/blob/master/docs/src/pages/guides/migration-v3/migration-v3.md).
 ...
 * Dica: você pode fornecer mais de 1 argumento:` theme.spacing (1, 2) // = '8px 16px'` *.
  ...
  Você pode usar o [auxiliar de migração] (https://github.com/quizlet/material-ui/tree/master/packages/material-ui-codemod/README.md#theme-spacing-api) em seu projeto para tornar isso mais suave.
...
- [Typography] Renomeie `color="default"` para `color="initial"` seguindo a lógica [desta discussão](https://github.com/quizlet/material-ui/issues/13028). O uso de *default* deve ser evitado, isso perde semântica.
